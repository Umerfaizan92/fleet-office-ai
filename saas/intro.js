(() => {
  ...
  function updateVoiceCapability(){
    ...
    else setVoiceStatus('Voice input and spoken replies are available. Super Pro will use the best matching installed voice or the device speech service.','ready');
  }
